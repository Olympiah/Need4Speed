...
#
#
# # The function is responsible for drawing the box on the license plate and vehicle
...
# # getting frame per sec
# fps = cap.get(cv2.CAP_PROP_FPS)
# # getting the frame width of image frame
# width = int(cap.get(cv2.CAP_PROP_FRAME_WIDTH))
# # getting height
# height = int(cap.get(cv2.CAP_PROP_FRAME_HEIGHT))
#
# # defining output video file
...
#     ret, frame = cap.read()
#
#     x1, y1, x2, y2 = ast.literal_eval(results[(results['car_id'] == vehicle_id) &
